						...
						<div class="col-md-6">
						  <div class="circle-tile ">
							...
							<div class="circle-tile-content dark-blue">
							  ...
							  <div class="circle-tile-number text-faded "><?php echo isset($applied_users['cnt'])?$applied_users['cnt']:''; ?></div>
						...
						<div class="col-md-6">
						  <div class="circle-tile ">
							...
							<div class="circle-tile-content red">
							  <div class="circle-tile-description text-faded">Posts List </div>
							  <div class="circle-tile-number text-faded "><?php echo isset($post_list['cnt'])?$post_list['cnt']:''; ?></div>
							  <a class="circle-tile-footer" href="#">More Info<i class="fa fa-chevron-circle-right"></i></a>
							</div>
						  </div>
						</div> 
