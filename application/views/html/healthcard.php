...
<!--Main layout-->
 <main class="mt-5">
        ...
        <img src="<?php echo base_url(); ?>assets/vendor/img/health-card.png" alt="Health Card" class="pt-4 mt-1" width="100%" style="max-height:480px;"> 
        <div class="container">
            ...
            <section class="mt-5 wow fadeIn">
                ...
                <div class="row features-small mb-5 mt-3 wow fadeIn">
                    ...
                    <div class="col-md-4 flex-center">
                        <img src="<?php echo base_url(); ?>assets/vendor/img/hospital-process.png" alt="Our Hospital Process" class="z-depth-0 img-fluid">
                    </div>
                    <!--/Second column-->
