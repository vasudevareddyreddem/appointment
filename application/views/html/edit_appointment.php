                ...
                <div class="col-md-8 mx-auto">
                    ...
                    <div class="card mb-3 wow fadeIn">
                        ...
                        <div class="card-body">
                            ...
                            <form onsubmit="return checkDate()" id="addappoinment" name="addappoinment" action="<?php echo base_url('appointment/editpost'); ?>" method="post">
							<input  type="hidden" name="a_id" id="a_id" value="<?php echo isset($details['b_id'])?$details['b_id']:''; ?>">
								<div class="form-group">
                                    <select id="city" name="city" class="form-control" onchange="get_hos_list(this.value)">
										...
										<?php if($details['city']==$list['hos_bas_city']){ ?>
										 <option selected value="<?php echo $list['hos_bas_city']; ?>"><?php echo $list['hos_bas_city']; ?></option>
										<?php }else{ ?>
                                ...
                                <div class="form-group">
                                    <select id="hospital_id" name="hospital_id" onchange="get_hospital_department(this.value);get_consultation_fee(this.value);" class="form-control">
										...
										<?php if($details['hos_id']==$list['hos_id']){ ?>
										 <option selected value="<?php echo $list['hos_id']; ?>"><?php echo $list['hos_bas_name']; ?></option>
										<?php }else{ ?>
                                ...
                                <div class="form-group">
                                    <select id="department" name="department" onchange="get_hospital_sepci(this.value);"  class="form-control">
										...
										<?php if($details['department']==$list['t_id']){ ?>
								...
								<div class="form-group">
                                    <select id="specilist" name="specilist" onchange="get_hospital_doctor(this.value);"  class="form-control">
										...
										<?php if(isset($specialist_list) && count($specialist_list)>0){ ?>
                                        <?php foreach($specialist_list as $list){ ?>
										<?php if($details['specialist']==$list['s_id']){ ?>
										 <option selected value="<?php echo $list['s_id']; ?>"><?php echo $list['specialist_name']; ?></option>
										<?php }else{ ?>
											 <option  value="<?php echo $list['s_id']; ?>"><?php echo $list['specialist_name']; ?></option>
                                ...
                                <div class="form-group">
                                    <select id="doctor_id" name="doctor_id" class="form-control">
                                        ...
                                        <?php if(isset($doctor_list) && count($doctor_list)>0){ ?>
                                        <?php foreach($doctor_list as $list){ ?>
										<?php if($details['doctor_id']==$list['a_id']){ ?>
										 <option selected value="<?php echo $list['a_id']; ?>"><?php echo $list['resource_name']; ?></option>
										<?php }else{ ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="date" name="date" min="<?php echo date('Y-m-d'); ?>" class="form-control" value="<?php echo isset($details['date'])?$details['date']:''; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
								...
								<div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" name="name" value="<?php echo isset($details['patinet_name'])?$details['patinet_name']:''; ?>"  class="form-control">
                                        </div>
                                    </div>
									<div class="col-md-6">
                                        <div class="form-group">
                                            <label for="">Age</label>
                                            <input type="text" id="age" name="age"  class="form-control" value="<?php echo isset($details['age'])?$details['age']:''; ?>">
                                        </div>
                                    </div>
                                </div>
